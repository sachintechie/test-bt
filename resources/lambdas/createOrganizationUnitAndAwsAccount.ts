...
import { IAMClient, CreateRoleCommand, CreateAccessKeyCommand, AttachUserPolicyCommand } from "@aws-sdk/client-iam";
        ...
        Statement: [
          {
            Effect: "Allow",
            Principal: {
              Service: ["ec2.amazonaws.com", "iam.amazonaws.com", "organizations.amazonaws.com"]
            },
