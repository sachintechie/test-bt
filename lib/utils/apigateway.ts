...
export const newMoonpayApiGateway = (
  scope: Construct,
  assetLambda: lambda.Function,
  deliveryLambda: lambda.Function,
  transactionStatusLambda: lambda.Function
) => {
  // Define the API Gateway
