...
export const getPlaygrounDevDatabaseInfo = (scope: Construct): DatabaseInfo => {
  ...
  return {
    databaseUrl: cdk.Fn.join("", [
      ...
      secret.secretValueFromJson("password").unsafeUnwrap(),
      "@",
      "auroracluster-playground-devinstance1.cvgkm26ccq9p.us-east-1.rds.amazonaws.com",
      ":5432/",
      DB_NAME
    ]),
    host: "auroracluster-playground-devinstance1.cvgkm26ccq9p.us-east-1.rds.amazonaws.com",
    port: "5432",
    dbName: DB_NAME,
